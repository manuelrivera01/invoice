<template>
  <div v-if="currentInvoice" class="invoice-view container">
    <router-link class="nav-link flex" :to="{ name: 'Home' }">
      <img src="@/assets/icon-arrow-left.svg" alt="" /> Regresar
    </router-link>
    <!-- Header -->
    <div class="header flex">
      <div class="left flex">
        ...
        >
          <span v-if="currentInvoice.invoicePaid">Pagado</span>
          <span v-if="currentInvoice.invoiceDraft">Borrador</span>
          <span v-if="currentInvoice.invoicePending">Pendiente</span>
        </div>
      </div>
      <div class="right flex">
        <button @click="toggleEditInvoice" class="blue">Editar</button>
        <button @click="deleteInvoice(currentInvoice.docId)" class="red">Eliminar</button>
