<template>
  <div @click="checkClick" ref="invoiceWrap" class="invoice-wrap flex flex-column">
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <h1 v-if="!editInvoice">Nueva Factura</h1>
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="billerStreetAddress">Dirección</label>
          <input required type="text" id="billerStreetAddress" v-model="billerStreetAddress" />
        </div>
        <div class="location-details flex">
          <div class="input flex flex-column">
            <label for="billerCity">Ciudad</label>
            <input required type="text" id="billerCity" v-model="billerCity" />
          </div>
          <div class="input flex flex-column">
            <label for="billerZipCode">Código Zip</label>
      ...
      <div class="bill-to flex flex-column">
        ...
        <div class="input flex flex-column">
          <label for="clientStreetAddress">Dirección</label>
        ...
        <div class="location-details flex">
          ...
          <div class="input flex flex-column">
            <label for="clientZipCode">Código Zip</label>
      ...
      <div class="invoice-work flex flex-column">
        <div class="payment flex">
          ...
          <div class="input flex flex-column">
            <label for="paymentDueDate">Fecha de Pago</label>
            <input disabled type="text" id="paymentDueDate" v-model="paymentDueDate" />
          </div>
        </div>
        <div class="input flex flex-column">
          <label for="paymentTerms">Plazo a Pagar</label>
        ...
        <div class="work-items">
          ...
          <table class="item-list">
            <tr class="table-heading flex">
              <th class="item-name">Nombre de Producto</th>
      ...
      <div class="save flex">
        ...
        <div class="right flex">
          <button v-if="!editInvoice" type="submit" @click="saveDraft" class="dark-purple">Guardar Borrador</button>
          <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Crear Factura</button>
          <button v-if="editInvoice" type="sumbit" class="purple">Actualizar Factura</button>
        </div>
      </div>
    </form>
  </div>
